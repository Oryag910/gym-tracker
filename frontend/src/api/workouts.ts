...
export interface ExerciseData {
  ...
  is_unilateral?: boolean; is_timed?: boolean; attachment?: string | null
}
...
export const updateSet = (workoutId: number, exerciseId: number, setId: number, data: { weight?: number; reps?: number; rpe?: number; weight_right?: number; reps_right?: number; duration?: number }) =>
  client.put(`/workouts/${workoutId}/exercises/${exerciseId}/sets/${setId}`, data)

export const addExercise = (workoutId: number, data: { name: string; is_unilateral?: boolean; is_timed?: boolean; attachment?: string | null }) =>
  client.post<ExerciseResponse>(`/workouts/${workoutId}/exercises`, data)

export const updateExercise = (workoutId: number, exerciseId: number, data: { name?: string; is_unilateral?: boolean; is_timed?: boolean; attachment?: string | null }) =>
...
export const addSet = (workoutId: number, exerciseId: number, data: { weight?: number | null; reps?: number | null; rpe?: number | null; weight_right?: number | null; reps_right?: number | null; duration?: number | null }) =>
